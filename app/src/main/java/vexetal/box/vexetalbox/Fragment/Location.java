...
public class Location extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_location2, container, false);
                        ...
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if(dataSnapshot.exists()){
                                    ...
                                    try {
                                        android.location.Location.distanceBetween(Double.parseDouble(s[0]), Double.parseDouble(s[1]), Double.parseDouble(r[0]), Double.parseDouble(r[1]), results);
